...
<?php if ($_SESSION['admin'] == 2): ?>
    ...
    <body id="body" onload="send();">
        ...
        <h4 class="admin-cabinet_1" id="title-top">Ваше расширение окна браузера не подходит для отображения личного
            кабинета</h4>
        <div class="wrapper-menu">
            ...
            <div class="wrapper-menu-header">
                <div class="wrapper-menu-header-element" style="border-bottom-style: none"
                    id="wrapper-menu-header-element1">
                ...
                <form name="contact_form" method="post" id="myform" action="post.php" onsubmit="return validate_form();">
                    <div>
                        ...
                        <div class="no-demand" style="margin: 30px 0 ">
                            ...
                            <p style="margin: 12px 30px; font-size: 16px; color: rgb(155, 75, 55);">&#10004; Создание новой
                                заявки.</p>
                        </div>
                        ...
                        <div class="input-pacient-row">
                            ...
                            <div>
                                <div>
                                    <p class="input-date-demand-text">Дата заявки: <span
                                            style="color: red;font-weight:bold; font-size: 15px;">*</span> </p>
                                </div>

                                <div class="input-date-div-demand">
                                    <input step="any" class="input-date-demand" type="datetime-local"
                                        value="<?php echo $datatime; ?>" name="calendar" id="calendar">
                            ...
                            <div style="margin-left: 50px">
                                <div>
                                    <p class="input-date-demand-text">Забор анализа: <span
                                            style="color: red;font-weight:bold; font-size: 15px;">*</span> </p>
                                </div>

                                <div class="input-date-div-demand">
                                    <input step="any" class="input-date-demand" type="datetime-local"
                                        value="<?php echo $datatime; ?>" name="dataanaliz" id="dataanaliz">
                        ...
                        <div class="input-box" id="lol">
                            ...
                            <div class="input-pacient-row">
                                <div>
                                    ...
                                    <div>
                                        <input class="input-date-demand" type="date" name="dateofbirth1c" id="dateofbirth"
                                            value="2000-01-01">
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div>
                                        <input class="check-urgently" type="checkbox" name="smear" value="cervical">
                                        Cervical
                                    </div>
                                    <div>
                    ...
                    <fieldset class="customer-information">
                        ...
                        <div class="customer-information-row">
                            <div>
                                ...
                                <div>
                                    <input class="input-department" type="text" placeholder="Отдел травматологии"
                                        name="department">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input class="input-doctor" type="text" placeholder="Фамилия" style="with: 150px"
                                        name="doctorsurname">
                                    <input class="input-doctor" type="text" placeholder="Имя" style="with: 150px"
                                        name="doctorname">
                                    <input class="input-doctor" type="text" placeholder="Отчество" style="with: 150px"
                    ...
                    <hr style="margin-bottom: 4px; color: rgb(152, 145, 145);">
                    </hr>
                    ...
                    <div class="all-issl" id="all-issl" style="display: flex; flex-direction: row; margin-top: 15px; ">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <input class="poisk" id="poisk" type="text" placeholder="" name="">
                            <div class="box-issl-res" id="box-issl-res"
                                style="width: 400px; overflow-y:scroll; height: 350px;">
                        ...
                        <div class="box-issl-itog" id="box-issl-itog"
                            style="width: 440px; height: 350px; overflow-y:scroll;">

                            <div class="container-result" id="container-result" style=" ">
                    ...
                    <div style="margin-top: 50px; margin-bottom: 50px; "> <button type="submit" class="button_cabinet"
                            id="save">Сохранить</<button>
                    </div>
                </form>
            </div>
        ...
        <script>
            var input = document.getElementById('poisk');
            input.oninput = function () {
                vid_issl = document.getElementById(vid_issl_mas[0]);
                param = { poisk: input.value, row_issl: vid_issl.innerHTML };
                findservice(param);
                // alert(param.row_issl);
            };

            function obr_mass(mass){
                let ok = ""; 
            ...
            function validate_form() {
                ...
                if (res.length == 0) {
                    document.getElementById('box-issl-itog').classList.add("input-style-no");

                    valid = false;
                } else {

                    res_str = obr_mass(res);
                    // alert(res_str)
                    ...
                    document.getElementById('box-issl-itog').classList.remove("input-style-no");
                }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (a = 0; a < vid_iss.length; a++) {
                            ...
                            div.id = "service&" + vid_iss[a].name + "<strong>" + "  " + vid_iss[a].code + "</strong>";
                            div.innerHTML = vid_iss[a].name + "<strong>" + "  " + vid_iss[a].code + "</strong>";
            ...
            $(document).ready(function ($) {
                $('#all-issl').on("click", function (event) {
                    ...
                    if (str.includes(vid_issl) == true) {
                        ...
                        if (vid_issl_mas.length > 0) {
                            el_name = vid_issl_mas[0];
                            let el = document.querySelector('#' + el_name);
                            el.style.background = "rgb(255, 255, 255)";
                        }
                        vid_issl_mas.length = 0;
                        vid_issl_mas.push(str);
                        issl.style.background = "rgb(223, 122, 122)";
                        ...
                        // alert(str);
                        let service = document.getElementById(str);
                        // alert(str);
                        ...
                        if (service.style.background == "rgb(223, 122, 122)") {
                            ...
                            close = document.getElementById("img&" + service_name);
                            close.remove();

                            container = document.getElementById("container-result&" + service_name);
                            container.remove();
                            ...
                            var div = document.createElement('div');
                            let box_issl = document.querySelector('#box-issl-itog');
                            box_issl.appendChild(div);
                            div.classList.add("container-result");
                            div.id = "container-result&" + service_name;

                            var div1 = document.createElement('div');
                            let box_issl1 = document.getElementById("container-result&" + service_name);
                            ...
                            let box_issl2 = document.getElementById("container-result&" + service_name);
                            box_issl2.appendChild(img);
                            img.src = "/images/icon-close.png?t=" + Math.floor(Math.random() * (100000 - 1000 + 1)) + 1000;
                            img.classList.add("icon-close");
                            img.id = "img&" + service_name;
                    ...
                    } else if (str.includes(close_ico) == true) {

                        // alert('Крестик');
                        element = document.getElementById(str);
                        elementName = element.id;
                        elementNameIt = elementName.split('&');
                        service_name = elementNameIt[1];
                        // alert(elementNameIt);
                        ...
                        close = document.getElementById("img&" + service_name);
                        // alert("Крестик: " + close.id);
                        close.remove();


                        container = document.getElementById("container-result&" + service_name);
                        // alert("Контейнер: " + container.id)
                        container.remove();

                        index = res.indexOf(service_name);
                        // alert(index);
                        if (index != -1) {
                            res.splice(index, 1);
                            // alert("Индекс удален: " + index);
                        }
                        // alert(service_name);        
                        let service = document.getElementById('service&' + service_name);

                        // alert("Услуга: " + service);
                        if (service != null) {
            ...
            function send() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.querySelectorAll('.icon-close').forEach(function (a) {
                            a.remove()
                        })
                        document.querySelectorAll('.container-result').forEach(function (a) {
                            a.remove()
                        })
                        for (a = 0; a < vid_iss.length; a++) {
